...
try:
    # 测试项目统计数据API
    response = requests.get('http://localhost:8001/v1/project/stats', timeout=5)
    ...
    print("python -c \"import uvicorn; import main; uvicorn.run(main.app, host='0.0.0.0', port=8001)\"")
...
try:
    ...
    req = urllib.request.Request('http://localhost:8001/v1/project/stats')
